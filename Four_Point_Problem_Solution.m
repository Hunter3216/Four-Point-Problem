addpath([pwd '\Functions'],[pwd '\Functions\FourPoint']) %Loads functions
...
elseif (VectorAmount) == 0
    ...
    plot([0 PointMatrix(1,1)],[0 PointMatrix(1,2)],'k','LineWidth',2); hold on; %plots point connected to origin
...
elseif (VectorAmount) == 1 
   ...
   plot([PointMatrix(1,1) PointMatrix(2,1)],[PointMatrix(1,2) PointMatrix(2,2)],'k','LineWidth',2); hold on; %plots line connecting two points
...
elseif (VectorAmount) == 6
    FourPointMain(PointMatrix, VectorMatrix)
else
